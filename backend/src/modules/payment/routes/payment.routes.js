 ...
 */
router.patch("/:id/success", authenticate, authorize(UserRole.ADMIN), paymentController.markPaymentSuccess);
/**
 ...
 */
router.patch("/:id/fail", authenticate, authorize(UserRole.ADMIN), paymentController.markPaymentFailed);
/* -------------------------------------------------------------------------- */
/*                              CUSTOMER                                      */
/* -------------------------------------------------------------------------- */
/**
