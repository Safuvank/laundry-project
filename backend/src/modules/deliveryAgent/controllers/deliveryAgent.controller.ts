...
class DeliveryAgentController {
   ...
   * Admin only.
   */
  getAvailableAgents = asyncHandler(async (_req: Request, res: Response) => {
  ...
  updateStatus = asyncHandler(async (req: Request, res: Response) => {
    ...
    const agent = await deliveryAgentService.updateStatus(
      id,
      status as DeliveryAgentStatus,
    );
  ...
  updateLocation = asyncHandler(async (req: Request, res: Response) => {
    ...
    const agent = await deliveryAgentService.updateLocation(
      userId,
      Number(longitude),
      Number(latitude),
    );
   ...
   * Default radius = 5 km.
   */
  findNearbyAgents = asyncHandler(async (req: Request, res: Response) => {
    ...
    const agents = await deliveryAgentService.findNearbyAgents(
      longitudeNumber,
      latitudeNumber,
      radiusNumber,
    );
