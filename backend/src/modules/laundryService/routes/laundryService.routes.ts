...
router.get(
  ...
  laundryServiceController.getAll,
);
...
router.post(
  ...
  authenticate,
  authorize(UserRole.ADMIN),
  validateRequest(createLaundryServiceSchema),
...
router.patch(
  ...
  authenticate,
  authorize(UserRole.ADMIN),
  validateRequest(updateLaundryServiceSchema),
...
router.patch(
  ...
  authenticate,
  authorize(UserRole.ADMIN),
  laundryServiceController.activate,
);
...
router.patch(
  ...
  authenticate,
  authorize(UserRole.ADMIN),
  laundryServiceController.deactivate,
);
