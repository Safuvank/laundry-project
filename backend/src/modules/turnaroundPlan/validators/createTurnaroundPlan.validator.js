...
export const createTurnaroundPlanSchema = z
    ...
    message: "Minimum turnaround hours cannot be greater than maximum turnaround hours.",
    path: ["maxHours"],
})
    .refine((data) => !(data.pricingType === PricingType.NONE && data.priceAdjustment !== 0), {
    message: "Price adjustment must be 0 when pricing type is NONE.",
    path: ["priceAdjustment"],
})
    .refine((data) => !(data.pricingType === PricingType.PERCENTAGE &&
    data.priceAdjustment > 100), {
    message: "Percentage price adjustment cannot exceed 100.",
    path: ["priceAdjustment"],
});
//# sourceMappingURL=createTurnaroundPlan.validator.js.map