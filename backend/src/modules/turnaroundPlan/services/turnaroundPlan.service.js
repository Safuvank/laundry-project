...
export class TurnaroundPlanService {
    ...
    */
    async create(data) {
        ...
        if (data.minHours > data.maxHours) {
            throw new ValidationError("Minimum turnaround hours cannot be greater than maximum turnaround hours.");
        }
        /*
         * Validate pricing
         */
        ...
        if (existingPlan) {
            throw new ValidationError(`Turnaround plan with code ${data.code} already exists.`);
        }
        /*
    ...
    */
    async update(id, data) {
        ...
        const finalPriceAdjustment = data.priceAdjustment ?? existingPlan.priceAdjustment;
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    validatePricing(pricingType, priceAdjustment) {
        /*
        ...
        if (pricingType === PricingType.NONE && priceAdjustment !== 0) {
            throw new ValidationError("Price adjustment must be 0 when pricing type is NONE.");
        }
        /*
         * Percentage validation
         */
        if (pricingType === PricingType.PERCENTAGE && priceAdjustment > 100) {
            throw new ValidationError("Percentage price adjustment cannot exceed 100.");
        }
    }
}
export const turnaroundPlanService = new TurnaroundPlanService();
//# sourceMappingURL=turnaroundPlan.service.js.map