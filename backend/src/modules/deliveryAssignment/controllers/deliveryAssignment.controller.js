...
class DeliveryAssignmentController {
    ...
    create = asyncHandler(async (req, res) => {
        ...
        const assignment = await deliveryAssignmentService.create(orderId, deliveryAgentId, assignmentType);
     ...
     */
    createDeliveryAssignment = asyncHandler(async (req, res) => {
        ...
        /* ---------------------------------------------------------------------- */
        const assignment = await deliveryAssignmentService.createDeliveryAssignment(orderId, adminLatitude, adminLongitude);
        /* ---------------------------------------------------------------------- */
        /* Response                                                               */
        /* ---------------------------------------------------------------------- */
        return res.status(201).json({
     ...
     * Admin
     */
    getActiveByOrderId = asyncHandler(async (req, res) => {
        const orderId = req.params.orderId;
        if (typeof orderId !== "string") {
            return res.status(400).json({
                success: false,
        ...
        const assignment = await deliveryAssignmentService.getActiveByOrderId(orderId);
        return res.status(200).json({
            success: true,
     ...
     * Admin
     */
    getByAgentId = asyncHandler(async (req, res) => {
        ...
        const assignments = await deliveryAssignmentService.getByAgentId(deliveryAgentId);
        return res.status(200).json({
            success: true,
     ...
     * Admin
     */
    getActiveByAgentId = asyncHandler(async (req, res) => {
        const deliveryAgentId = req.params.deliveryAgentId;
        if (typeof deliveryAgentId !== "string") {
            return res.status(400).json({
                success: false,
        ...
        const assignment = await deliveryAssignmentService.getActiveByAgentId(deliveryAgentId);
        return res.status(200).json({
            success: true,
     ...
     */
    async getAuthenticatedDeliveryAgentId(userId) {
    ...
    getMyAssignments = asyncHandler(async (req, res) => {
        const deliveryAgentId = await this.getAuthenticatedDeliveryAgentId(req.user.userId);
        const assignments = await deliveryAssignmentService.getByAgentId(deliveryAgentId);
        return res.status(200).json({
            success: true,
    ...
    accept = asyncHandler(async (req, res) => {
        ...
        const deliveryAgentId = await this.getAuthenticatedDeliveryAgentId(req.user.userId);
        const assignment = await deliveryAssignmentService.accept(assignmentId, deliveryAgentId);
        return res.status(200).json({
            success: true,
    ...
    startPickup = asyncHandler(async (req, res) => {
        ...
        const deliveryAgentId = await this.getAuthenticatedDeliveryAgentId(req.user.userId);
        const assignment = await deliveryAssignmentService.startPickup(id, deliveryAgentId);
        return res.status(200).json({
            success: true,
    ...
    startDelivery = asyncHandler(async (req, res) => {
        ...
        const deliveryAgentId = await this.getAuthenticatedDeliveryAgentId(req.user.userId);
        const assignment = await deliveryAssignmentService.startDelivery(id, deliveryAgentId);
        return res.status(200).json({
            success: true,
    ...
    reject = asyncHandler(async (req, res) => {
        ...
        const assignment = rejectionReason !== undefined
            ? await deliveryAssignmentService.reject(id, deliveryAgentId, rejectionReason)
    ...
    complete = asyncHandler(async (req, res) => {
        ...
        const deliveryAgentId = await this.getAuthenticatedDeliveryAgentId(req.user.userId);
        const assignment = await deliveryAssignmentService.complete(id, deliveryAgentId);
        return res.status(200).json({
            success: true,
    ...
    getByStatus = asyncHandler(async (req, res) => {
        ...
        const assignments = await deliveryAssignmentService.getByStatus(assignmentStatus);
        return res.status(200).json({
            success: true,
            message: "Delivery assignments retrieved successfully.",
            data: assignments,
...
//# sourceMappingURL=deliveryAssignment.controller.js.map