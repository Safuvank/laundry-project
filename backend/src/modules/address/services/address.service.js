...
class AddressService {
    ...
    validateLocation(location) {
        ...
        if (longitude === undefined || latitude === undefined) {
            throw new ValidationError("Location must contain longitude and latitude.");
        }
        /* ---------------------------------------------------------------------- */
        /*                         NUMBER VALIDATION                              */
        /* ---------------------------------------------------------------------- */
        if (!Number.isFinite(longitude) || !Number.isFinite(latitude)) {
            throw new ValidationError("Longitude and latitude must be valid numbers.");
        }
        /* ---------------------------------------------------------------------- */
        /*                         ZERO LOCATION PROTECTION                       */
        /* ---------------------------------------------------------------------- */
        if (longitude === 0 && latitude === 0) {
            throw new ValidationError("Valid pickup location is required.");
        }
        /* ---------------------------------------------------------------------- */
        /*                         RANGE VALIDATION                               */
        /* ---------------------------------------------------------------------- */
     ...
     */
    async getAddressOrFail(addressId) {
     ...
     */
    async deactivate(userId, addressId) {
        this.validateUserId(userId);
        const address = await this.getById(userId, addressId);
