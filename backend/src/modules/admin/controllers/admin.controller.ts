...
class AdminController {
  ...
  getUsers = asyncHandler(async (req: Request, res: Response) => {
    const query = {
      ...
      ...(typeof req.query.accountStatus === "string" && {
        accountStatus: req.query.accountStatus as
          | "ACTIVE"
          | "SUSPENDED"
          | "BLOCKED",
      }),
  ...
  getDeliveryAgents = asyncHandler(async (req: Request, res: Response) => {
    const query = {
      page: Number(req.query.page) || 1,
      ...
      ...(typeof req.query.status === "string" && {
        status: req.query.status as DeliveryAgentStatus,
      }),
  ...
  getDeliveryAgentById = asyncHandler(async (req: Request, res: Response) => {
    const { id } = req.params;
  ...
  getAssignments = asyncHandler(async (req: Request, res: Response) => {
    const query = {
      ...
      ...(typeof req.query.status === "string" && {
        status: req.query.status as DeliveryAssignmentStatus,
      }),

      ...(typeof req.query.assignmentType === "string" && {
        assignmentType: req.query.assignmentType as DeliveryAssignmentType,
      }),
  ...
  getOverviewReport = asyncHandler(async (_req: Request, res: Response) => {
