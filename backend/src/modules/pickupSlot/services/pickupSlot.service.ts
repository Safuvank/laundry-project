...
//         await pickupSlotRepository.update(slot.id, {
...
//   async create(data: Partial<IPickupSlot>) {
...
//     return pickupSlotRepository.findById(updated.id);
//   }
...
//     const slot =
//       await pickupSlotRepository.activate(id);
...
//     const slot =
//       await pickupSlotRepository.deactivate(id);
