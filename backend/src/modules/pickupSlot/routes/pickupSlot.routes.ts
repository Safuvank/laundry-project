...
router.post(
  ...
  authenticate,
  authorize(UserRole.ADMIN),
  validateRequest(createPickupSlotSchema),
...
router.patch(
  ...
  authenticate,
  authorize(UserRole.ADMIN),
  validateRequest(updatePickupSlotSchema),
  pickupSlotController.update,
);
...
router.patch(
  ...
  authenticate,
  authorize(UserRole.ADMIN),
  pickupSlotController.deactivate,
);
