...
//    * Customer
//    */
//   getSlotsByDate = asyncHandler(async (req: Request, res: Response) => {
...
//     const slots = await pickupSlotService.getSlotsByDate(new Date(date));
...
class PickupSlotController {
  ...
  create = asyncHandler(
    async (req: Request, res: Response) => {
      const slot =
        await pickupSlotService.create(
          req.body,
        );
  ...
  getAvailableSlots = asyncHandler(
    async (req: Request, res: Response) => {
      const slots =
        await pickupSlotService.getAvailableSlots();

      return res.status(200).json({
        success: true,
        message:
          "Available pickup slots retrieved successfully.",
        data: slots,
      });
    },
  );
  ...
  getSlotsByDate = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const slots =
        await pickupSlotService.getSlotsByDate(
          parsedDate,
        );
  ...
  getAll = asyncHandler(
    async (req: Request, res: Response) => {
      const slots =
        await pickupSlotService.getAll();
  ...
  getById = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const slot =
        await pickupSlotService.getById(
          id,
        );
      ...
      return res.status(200).json({
        success: true,
        message:
          "Pickup slot retrieved successfully.",
        data: slot,
      });
    },
  );
  ...
  update = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const slot =
        await pickupSlotService.update(
          id,
          req.body,
        );
  ...
  activate = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const slot =
        await pickupSlotService.activate(
          id,
        );
      ...
      return res.status(200).json({
        success: true,
        message:
          "Pickup slot activated successfully.",
        data: slot,
      });
    },
  );
  ...
  deactivate = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      const slot =
        await pickupSlotService.deactivate(
          id,
        );
      ...
      return res.status(200).json({
        success: true,
        message:
          "Pickup slot deactivated successfully.",
        data: slot,
      });
    },
  );
...
export const pickupSlotController =
  new PickupSlotController();