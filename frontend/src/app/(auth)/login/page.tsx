  ...
  return (
    <div className="flex h-[100vh] w-full m-0 p-0 overflow-hidden bg-white">
      ...
      <div className="relative hidden h-full w-1/2 flex-col items-center justify-center bg-[#0d5eed] p-12 lg:flex">
        {/* Placeholder for the central abstract graphic */}
        <div className="relative flex w-full max-w-md items-center justify-center">
          ...
          {/* Main graphic container - replace img src with your actual asset */}
          <div className="relative z-10 w-full drop-shadow-2xl">
             <img
              ...
              className="rounded-2xl border border-white/10 bg-white/10 object-cover shadow-2xl backdrop-blur-sm"
        ...
        <div className="absolute bottom-16 text-center">
          ...
          <div className="flex justify-center gap-2.5">
            ...
            <div className="h-1.5 w-1.5 rounded-full bg-white/30 cursor-pointer transition-colors hover:bg-white/50"></div>
            <div className="h-1.5 w-1.5 rounded-full bg-white/30 cursor-pointer transition-colors hover:bg-white/50"></div>
          </div>
        </div>
      </div>
